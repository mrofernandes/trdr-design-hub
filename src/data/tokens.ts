...
export const tokens: DesignToken[] = [
  ...
  { name: 'bg/bg-brand', cssVar: '--bg-bg-brand', darkValue: '#00A8CC', lightValue: '#00A8CC', description: 'Fundo de áreas com destaque de marca primária. Usado em seções hero, banners de identidade TRDR e áreas de apresentação da marca.', category: 'semantico-bg', isColor: true },
  ...
  { name: 'content/brand', cssVar: '--content-brand', darkValue: '#00A8CC', lightValue: '#005266', description: 'Texto com cor da marca: links clicáveis, valores em destaque brand, labels interativos com identidade TRDR. Ex: "Link com ação" no hub, links de notícias na plataforma, valores com destaque ciano.', category: 'semantico-content', isColor: true },
  { name: 'content/info', cssVar: '--content-info', darkValue: '#00D4FF', lightValue: '#00A8CC', description: 'Texto de mensagens informativas e contexto não-crítico. Ciano — comunica informação sem urgência. Usar em tooltips, dicas de preenchimento e mensagens de sistema informativas.', category: 'semantico-content', isColor: true },
  ...
  // =========================================================================
  { name: 'action/brand/default', cssVar: '--action-brand-default', darkValue: '#00A8CC', lightValue: '#007D99', description: 'Estado padrão de ações com cor brand que NÃO são botões preenchidos. Usado em ícones interativos brand, indicadores ativos de aba, badges e highlights com identidade TRDR. Ciano médio — visível mas não dominante.', category: 'semantico-action', isColor: true },
  { name: 'action/brand/hover', cssVar: '--action-brand-hover', darkValue: '#007D99', lightValue: '#005266', description: 'Estado hover de ações brand. Versão ligeiramente mais intensa que /default para feedback de mouse over em ícones, indicadores e elementos brand.', category: 'semantico-action', isColor: true },
  { name: 'action/brand/active', cssVar: '--action-brand-active', darkValue: '#005266', lightValue: '#002933', description: 'Estado ativo/pressionado/selecionado de ações brand. Mais intenso que /default. Ex: underline ciano sob aba ativa na página de tokens do hub.', category: 'semantico-action', isColor: true },
  ...
  // =========================================================================
  { name: 'action/brand inverse/default', cssVar: '--action-brand-inverse-default', darkValue: '#005266', lightValue: '#00A8CC', description: 'Background do botão CTA primário — o call-to-action mais importante de cada tela. Ciano escuro e sólido. O texto deve ser content/primary (branco). Ex: botão "Gerar prompts" no hub. Usar apenas uma vez por contexto.', category: 'semantico-action', isColor: true },
