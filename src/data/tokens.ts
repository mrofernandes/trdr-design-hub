...
export const tokens: DesignToken[] = [
  ...
  // =========================================================================
  { name: 'color.blue.50', cssVar: '--color-blue-50', darkValue: '#E6FEFF', description: 'Ciano mais claro', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.100', cssVar: '--color-blue-100', darkValue: '#CCFDFF', description: 'Ciano 100', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.200', cssVar: '--color-blue-200', darkValue: '#99F9FF', description: 'Ciano 200', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.300', cssVar: '--color-blue-300', darkValue: '#5CF3FF', description: 'Ciano 300', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.400', cssVar: '--color-blue-400', darkValue: '#29ECFF', description: 'Ciano 400 — surface.interactive (light)', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.500', cssVar: '--color-blue-500', darkValue: '#00D4FF', description: 'Ciano 500 — border.focus', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.600', cssVar: '--color-blue-600', darkValue: '#00A8CC', description: 'Ciano 600 — content.brand / action.brand.default (dark)', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.700', cssVar: '--color-blue-700', darkValue: '#007D99', description: 'Ciano 700 — hover do brand', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.800', cssVar: '--color-blue-800', darkValue: '#005266', description: 'Ciano 800 — active / CTA primário (dark)', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.900', cssVar: '--color-blue-900', darkValue: '#002933', description: 'Ciano 900 — mais escuro', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.alpha.08', cssVar: '--color-blue-alpha-08', darkValue: '#00D4FF14', description: 'Ciano com alpha 8%', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.alpha.16', cssVar: '--color-blue-alpha-16', darkValue: '#00D4FF29', description: 'Ciano com alpha 16%', category: 'primitivo-cor', isColor: true },
  { name: 'color.blue.alpha.32', cssVar: '--color-blue-alpha-32', darkValue: '#00D4FF52', description: 'Ciano com alpha 32%', category: 'primitivo-cor', isColor: true },
  ...
  { name: 'bg/overlay', cssVar: '--bg-overlay', darkValue: '#FFFFFF29', lightValue: '#FFFFFF52', description: 'Fundo de overlays, modais e drawers. Cobre o conteúdo abaixo com opacidade para focar atenção no modal. Sempre combinar com opacity/overlay. Nunca usar como fundo de página ou painel fixo.', category: 'semantico-bg', isColor: true },
  ...
  { name: 'bg/bg-brand', cssVar: '--bg-bg-brand', darkValue: '#00D4FF', lightValue: '#00A8CC', description: 'Fundo de áreas com destaque de marca primária. Usado em seções hero, banners de identidade TRDR e áreas de apresentação da marca.', category: 'semantico-bg', isColor: true },
  ...
  { name: 'surface/brand', cssVar: '--surface-brand', darkValue: '#00D4FF29', lightValue: '#00D4FF29', description: 'Superfície com cor brand para badges, tags e elementos com identidade visual TRDR. Usar em rótulos de produto, badges de destaque e elementos que comunicam pertencimento à marca.', category: 'semantico-surface', isColor: true },
  { name: 'surface/info', cssVar: '--surface-info', darkValue: '#00D4FF14', lightValue: '#00D4FF14', description: 'Fundo semi-transparente ciano sutil para indicar contexto informativo em células, seções ou banners. Usar em tooltips expandidos e áreas de informação não-crítica.', category: 'semantico-surface', isColor: true },
  ...
  { name: 'surface/warning', cssVar: '--surface-warning', darkValue: '#FFCC4014', lightValue: '#FFCC4014', description: 'Fundo semi-transparente levíssimo (amarelo ~8% alpha) para indicar contexto de aviso em células ou áreas. Usar em linhas com condição de atenção — margem baixa, valores próximos do limite.', category: 'semantico-surface', isColor: true },
  { name: 'surface/error', cssVar: '--surface-error', darkValue: '#F1312614', lightValue: '#F1312614', description: 'Fundo semi-transparente levíssimo (vermelho ~8% alpha) para indicar contexto de erro em células ou linhas. Ex: linha da order book com ordem rejeitada. Nunca usar como fundo de card inteiro.', category: 'semantico-surface', isColor: true },
  ...
  { name: 'content/placeholder', cssVar: '--content-placeholder', darkValue: '#A4A4A4', lightValue: '#777777', description: 'Cor de texto placeholder em campos de input. Indica ao usuário o tipo de dado esperado. Desaparece ao digitar — nunca usar para texto de conteúdo permanente.', category: 'semantico-content', isColor: true },
  ...
  { name: 'content/inverse', cssVar: '--content-inverse', darkValue: '#1A1A1A', lightValue: '#FFFFFF', description: 'Texto escuro para uso sobre fundos claros, coloridos ou de alta luminosidade. Ex: label sobre superfície brand. Nunca usar sobre backgrounds escuros — o contraste seria insuficiente.', category: 'semantico-content', isColor: true },
  { name: 'content/brand', cssVar: '--content-brand', darkValue: '#00D4FF', lightValue: '#007D99', description: 'Texto com cor da marca: links clicáveis, valores em destaque brand, labels interativos com identidade TRDR. Ex: "Link com ação" no hub, links de notícias na plataforma, valores com destaque ciano.', category: 'semantico-content', isColor: true },
  { name: 'content/info', cssVar: '--content-info', darkValue: '#CCFDFF', lightValue: '#00A8CC', description: 'Texto de mensagens informativas e contexto não-crítico. Ciano muito claro no dark — comunica informação sem urgência. Usar em tooltips, dicas de preenchimento e mensagens de sistema informativas.', category: 'semantico-content', isColor: true },
  ...
  { name: 'border/focus', cssVar: '--border-focus', darkValue: '#00D4FF', lightValue: '#00D4FF', description: 'Cor de borda quando um elemento interativo recebe foco via teclado. Fundamental para acessibilidade — nunca remover ou sobrescrever em componentes focáveis. Deve ser sempre visível sobre qualquer background.', category: 'semantico-border', isColor: true },
  ...
  // =========================================================================
  { name: 'action/brand/default', cssVar: '--action-brand-default', darkValue: '#00D4FF', lightValue: '#00A8CC', description: 'Estado padrão de ações com cor brand que NÃO são botões preenchidos. Usado em ícones interativos brand, indicadores ativos de aba, badges e highlights com identidade TRDR. Ciano — visível mas não dominante.', category: 'semantico-action', isColor: true },
  { name: 'action/brand/hover', cssVar: '--action-brand-hover', darkValue: '#00A8CC', lightValue: '#007D99', description: 'Estado hover de ações brand. Versão ligeiramente mais intensa que /default para feedback de mouse over em ícones, indicadores e elementos brand.', category: 'semantico-action', isColor: true },
  { name: 'action/brand/active', cssVar: '--action-brand-active', darkValue: '#007D99', lightValue: '#005266', description: 'Estado ativo/pressionado/selecionado de ações brand. Mais intenso que /default. Ex: underline ciano sob aba ativa na página de tokens do hub.', category: 'semantico-action', isColor: true },
  ...
  { name: 'action/brand/alpha', cssVar: '--action-brand-alpha', darkValue: '#00D4FF14', lightValue: '#00D4FF14', description: 'Versão semi-transparente da cor brand para highlights, overlays e indicadores sutis com identidade TRDR.', category: 'semantico-action', isColor: true },
  // =========================================================================
  // SEMÂNTICOS — AÇÕES: BRAND INVERSE (CTA)
  // =========================================================================
  { name: 'action/brand inverse/default', cssVar: '--action-brand-inverse-default', darkValue: '#005266', lightValue: '#00A8CC', description: 'Background do botão CTA primário — o call-to-action mais importante de cada tela. Ciano sólido. O texto deve ser content/primary (branco no dark, preto no light). Ex: botão "Gerar prompts" no hub. Usar apenas uma vez por contexto.', category: 'semantico-action', isColor: true },
  { name: 'action/brand inverse/hover', cssVar: '--action-brand-inverse-hover', darkValue: '#007D99', lightValue: '#007D99', description: 'Estado hover do botão CTA primário. Versão ligeiramente mais clara para feedback de mouse over.', category: 'semantico-action', isColor: true },
  { name: 'action/brand inverse/active', cssVar: '--action-brand-inverse-active', darkValue: '#002933', lightValue: '#005266', description: 'Estado pressionado/clicado do botão CTA primário.', category: 'semantico-action', isColor: true },
  ...
  { name: 'action/brand inverse/alpha', cssVar: '--action-brand-inverse-alpha', darkValue: '#00D4FF14', lightValue: '#00D4FF14', description: 'Versão semi-transparente do CTA brand inverse para overlays e highlights sutis.', category: 'semantico-action', isColor: true },
  // =========================================================================
  ...
  { name: 'action/secondary/alpha', cssVar: '--action-secondary-alpha', darkValue: '#FFFFFF00', lightValue: '#FFFFFF00', description: 'Versão completamente transparente — usada como ponto inicial em transições ou overlays que partem do zero.', category: 'semantico-action', isColor: true },
  // =========================================================================
  ...
  { name: 'action/destructive/alpha', cssVar: '--action-destructive-alpha', darkValue: '#F9731614', lightValue: '#F9731614', description: 'Versão semi-transparente de ação destrutiva para highlights sutis de risco.', category: 'semantico-action', isColor: true },
  ...
  // =========================================================================
  { name: 'context/trading/short/default', cssVar: '--context-trading-short-default', darkValue: '#F1312614', lightValue: '#F131261F', description: 'Fundo muito sutil vermelho (~8% alpha) para indicar posição short aberta. Análogo a /long/default para o lado vendido.', category: 'semantico-trading', isColor: true },
  { name: 'context/trading/short/hover', cssVar: '--context-trading-short-hover', darkValue: '#F1312629', lightValue: '#F1312652', description: 'Estado hover de linha de posição short. Feedback visual de mouse over em rows de posição vendida.', category: 'semantico-trading', isColor: true },
  { name: 'context/trading/short/active', cssVar: '--context-trading-short-active', darkValue: '#F1312652', lightValue: '#F1312666', description: 'Estado ativo/selecionado de linha de posição short.', category: 'semantico-trading', isColor: true },
  ...
  { name: 'context/trading/stop/stop-alpha', cssVar: '--context-trading-stop-alpha', darkValue: '#F9731614', lightValue: '#F9731614', description: 'Versão semi-transparente da cor de stop loss para highlights sutis de risco em áreas de stop no gráfico.', category: 'semantico-trading', isColor: true },
